    ...
    <div className={`container mx-auto px-4 py-16`}>
      <section className="text-center mb-20">
        ...
        <h1 className="text-6xl font-bold mb-6 text-gray-800 tracking-tight">
          E-Waste <span className="text-green-600">Material Management</span>
        </h1>
      ...
      <section className="bg-white p-10 rounded-3xl shadow-lg mb-20">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          ...
          <ImpactCard title="Reports Submitted" value={`10`} icon={MapPin} />
          <ImpactCard title="Tokens Earned" value={`10`} icon={Coins} />
          <ImpactCard title="CO2 Offset" value={`10 kg`} icon={Leaf} />
        </div>
      </section>
    </div>
  );
